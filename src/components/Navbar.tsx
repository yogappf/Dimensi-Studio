      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            {/* Portal Admin Switcher Button */}
            {activeTab === 'admin' ? (
              <button
                onClick={() => setActiveTab('showcase')}
                className="flex items-center gap-2 px-3.5 py-2 text-[11px] font-semibold uppercase tracking-wider bg-white/10 hover:bg-white/20 text-white border border-white/20 transition-all cursor-pointer"
