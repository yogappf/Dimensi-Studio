...
export const INDONESIAN_BANK_PRESETS: BankPreset[] = [
  ...
  },
  {
    ...
    name: 'Bank Mandiri',
    shortName: 'Mandiri',
    badgeBg: 'bg-gradient-to-r from-[#D4AF37] to-[#AA7C11]',
    badgeBorder: 'border-[#FFF0A8]/50',
    textColor: 'text-[#FFF0A8]',
  ...
  },
  {
    ...
    name: 'Bank Danamon',
    shortName: 'Danamon',
    badgeBg: 'bg-gradient-to-r from-[#FFE082] to-[#D4AF37]',
    badgeBorder: 'border-[#FFF0A8]/60',
  ...
  },
  {
    ...
    name: 'Bank Mega',
    shortName: 'Bank Mega',
    badgeBg: 'bg-gradient-to-r from-[#F5D77F] to-[#9A7B1C]',
    badgeBorder: 'border-[#FFF0A8]/40',
    textColor: 'text-[#FFF0A8]',
    accentColor: 'border-[#D4AF37]',
