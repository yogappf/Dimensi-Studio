...
export async function saveBookingToFirestore(order: BookingOrder): Promise<void> {
  ...
  try {
    ...
    const cleanPayload: Record<string, any> = {
      ...
      notes: order.notes || '',
      hasSecondSession: Boolean(order.hasSecondSession || order.sessionDate2),
      sessionDate2: order.sessionDate2 || '',
      sessionTime2: order.sessionTime2 || '',
      locationType2: order.locationType2 || 'studio',
      locationAddress2: order.locationAddress2 || '',
      notes2: order.notes2 || '',
    ...
    (snapshot) => {
      ...
      snapshot.forEach((docSnapshot) => {
        ...
        orders.push({
          ...
          notes: data.notes || '',
          hasSecondSession: data.hasSecondSession !== undefined ? data.hasSecondSession : Boolean(data.sessionDate2),
          sessionDate2: data.sessionDate2 || undefined,
          sessionTime2: data.sessionTime2 || undefined,
          locationType2: data.locationType2 || undefined,
          locationAddress2: data.locationAddress2 || undefined,
          notes2: data.notes2 || undefined,
